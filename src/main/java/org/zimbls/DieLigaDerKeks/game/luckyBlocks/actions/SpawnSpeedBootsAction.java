...
import org.zimbls.DieLigaDerKeks.game.luckyBlocks.customArmor.SpeedBoots;

import java.util.Objects;

public class SpawnSpeedBootsAction extends LuckyBlockAction {
    @Override
    public void run() {
        Location blockLocation = super.playerLuckyBlockData.getBlockLocation();
        Objects.requireNonNull(blockLocation.getWorld()).dropItemNaturally(blockLocation, new SpeedBoots().getItemStack());
